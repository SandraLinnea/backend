...
function getBooking(sb, id) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data, error } = yield sb.from("bookings").select("*").eq("booking_id", id).single();
        if (error)
            throw error;
        return data;
    });
}
function createBooking(sb, booking) {
    return __awaiter(this, void 0, void 0, function* () {
...
function updateBooking(sb, id, booking) {
    return __awaiter(this, void 0, void 0, function* () {
        const bookingWithoutId = Object.assign(Object.assign({}, booking), { booking_code: undefined });
